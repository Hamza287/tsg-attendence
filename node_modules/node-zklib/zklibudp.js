...
class ZKLibUDP {
  ...
  async setTime(date = new Date()) {
    ...
    // 6-byte short format [sec, min, hour, day, month, year-2000]
    const buf = Buffer.alloc(6)
    buf.writeUInt8(second, 0)
    buf.writeUInt8(minute, 1)
    buf.writeUInt8(hour, 2)
    buf.writeUInt8(day, 3)
    buf.writeUInt8(month, 4)
    buf.writeUInt8(year - 2000, 5)

    return await this.executeCmd(COMMANDS.CMD_SET_TIME, buf)
  }
